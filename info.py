...
# Bot information
API_ID = environ.get('API_ID', '29362464')
if len(API_ID) == 0:
...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6229577338:AAGUnZ5t7I6v-iChVn7BhCqN2kKVhCR509Q')
if len(BOT_TOKEN) == 0:
...
# Bot pics
PICS = (environ.get('PICS', 'https://graph.org/file/ef5e9c9d9c23e41acdd94.jpg')).split()

# Bot Admins
ADMINS = environ.get('ADMINS', '5533079371')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001866646571 -1001962098016').split()]
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1001950005931').split()]
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001678010811')
...
VERIFY_EXPIRE = int(environ.get('VERIFY_EXPIRE', 43200)) # Add time in seconds #24-86400
IS_VERIFY = is_enabled(environ.get("IS_VERIFY", "True"), False)
WELCOME_TEXT = environ.get("WELCOME_TEXT", script.WELCOME_TEXT)
TUTORIAL = environ.get("TUTORIAL", "https://t.me/links_tutorialbypp/32")
